...
class Game {
    ...
    requestNominatedPresidentChooseChancellor(player) {
        ...
        io.to(nominatedPresident.id).emit('pick chancellor', { data: possibleChancellors, callback: callbackID, title: 'You have been chosen as president for a special election, choose a chancellor' });
