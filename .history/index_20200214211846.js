...
class Game {
    ...
    requestPresidentChooseChancellor() {
        ...
        callbacks[callbackID] = function (data) { return this.requestVoteOnPair(data) };
        io.to(this.currentPresident.id).emit('pick chancellor', { data: cloneArr, callback: callbackID });
    }
    ...
    requestVoteOnPair(data) {
        ...
        // let data = [];
        console.log(this.nominatedChancellor.name)
