...
class Game {
    ...
    requestNominatedPresidentChooseChancellor(player) {
        ...
        io.to(player.id).emit('pick chancellor', { data: possibleChancellors, callbackb: callbackID, title: 'You have been chosen as president for a special election, choose a chancellor' });
    }
